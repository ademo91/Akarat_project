...
<form class="max-w-lg mx-auto mt-10 shadow-lg" action="{{ route('dashboard') }}" method="GET">
    @csrf
    <div class="flex">
...
<!-- <h1 class="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-4 text-start"><a href="/dashboard">All Properties</a></h1> -->
</div>
<!-- navigation menu -->